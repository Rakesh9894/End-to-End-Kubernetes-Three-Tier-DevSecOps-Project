...
addons = [
  { name = "vpc-cni", version = "1.18.1-eksbuild.1" },
  { name = "coredns", version = "1.11.1-eksbuild.4" },
  { name = "kube-proxy", version = "1.32.3-eksbuild.2" },
  { name = "aws-ebs-csi-driver", version = "1.33.0-eksbuild.1" }
]
